...
Crashes_1 <- read.csv(file.choose(), header = TRUE)
Crashes_2 <- read.csv(file.choose(), header = TRUE)
Crashes_3 <- read.csv(file.choose(), header = TRUE)
Crashes_4 <- read.csv(file.choose(), header = TRUE)
Crashes_5 <- read.csv(file.choose(), header = TRUE)
Crashes_6 <- read.csv(file.choose(), header = TRUE)
Crashes_7 <- read.csv(file.choose(), header = TRUE)
Crashes_8 <- read.csv(file.choose(), header = TRUE)
Crashes_9 <- read.csv(file.choose(), header = TRUE)
Crashes_10 <- read.csv(file.choose(), header = TRUE)
Crashes_11 <- read.csv(file.choose(), header = TRUE)
Crashes_12 <- read.csv(file.choose(), header = TRUE)

Crashes <- rbind(Crashes_1, Crashes_2, Crashes_3, Crashes_4, Crashes_5, Crashes_6, Crashes_7, Crashes_8, Crashes_9, Crashes_10,
                 Crashes_11, Crashes_12)
## Choose "Crash_Data.csv" after downloading from Google Drive
...
Vehicle_1 <- read.csv(file.choose(), header = TRUE)
Vehicle_2 <- read.csv(file.choose(), header = TRUE)
Vehicle_3 <- read.csv(file.choose(), header = TRUE)
Vehicle_4 <- read.csv(file.choose(), header = TRUE)
Vehicle_5 <- read.csv(file.choose(), header = TRUE)
Vehicle_6 <- read.csv(file.choose(), header = TRUE)
Vehicle_7 <- read.csv(file.choose(), header = TRUE)
Vehicle_8 <- read.csv(file.choose(), header = TRUE)
Vehicle_9 <- read.csv(file.choose(), header = TRUE)
Vehicle_10 <- read.csv(file.choose(), header = TRUE)
Vehicle_11 <- read.csv(file.choose(), header = TRUE)
Vehicle_12 <- read.csv(file.choose(), header = TRUE)
Vehicle_13 <- read.csv(file.choose(), header = TRUE)
Vehicle_14 <- read.csv(file.choose(), header = TRUE)
Vehicle_15 <- read.csv(file.choose(), header = TRUE)
Vehicle_16 <- read.csv(file.choose(), header = TRUE)
Vehicle_17 <- read.csv(file.choose(), header = TRUE)
Vehicle_18 <- read.csv(file.choose(), header = TRUE)
Vehicle_19 <- read.csv(file.choose(), header = TRUE)
Vehicle_20 <- read.csv(file.choose(), header = TRUE)


Vehicle <- rbind(Vehicle_1, Vehicle_2, Vehicle_3, Vehicle_4, Vehicle_5, Vehicle_6, Vehicle_7, Vehicle_8, Vehicle_9, Vehicle_10,
                 Vehicle_11, Vehicle_12, Vehicle_13, Vehicle_14, Vehicle_15, Vehicle_16, Vehicle_17, Vehicle_18, Vehicle_19, Vehicle_20)
...
saveRDS(Unique_Crashes, "Unique Crashes.rds")
...
saveRDS(Iowa_County_Merged, "Iowa Counties.rds")

state <- map_data("state")
iowa <- subset(state, region == "iowa")

saveRDS(state, "state.rds")
saveRDS(iowa, "iowa.rds")
